<?php
/**
 * Catch Full Theme Options Sanitization Functions
 *
 ...
 */
function catch_fullscreen_sanitize_select( $input, $setting ) {
 ...
 */
function catch_fullscreen_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function catch_fullscreen_sanitize_post( $input ) {
 ...
 */
function catch_fullscreen_sanitize_image( $image, $setting ) {
    /*
 ...
 */
function catch_fullscreen_sanitize_category_list( $input ) {
 ...
 *                    the setting default.
 */
function catch_fullscreen_sanitize_number_range( $number, $setting ) {
