					...
					?>
						...
						<?php if ( $header_media_url_text ) : ?>
							<span class="more-button">
								<a class="more-link" href="<?php echo esc_url( $header_media_url ); ?>" target="<?php echo esc_attr( get_theme_mod( 'catch_fullscreen_header_url_target' ) ) ? '_blank' : '_self'; ?>"><?php echo esc_html( $header_media_url_text ); ?><span class="screen-reader-text"><?php echo wp_kses_post( $header_media_title ); ?></span></a>
							</span>
						<?php endif; ?>
					<?php endif; ?>
				</div> <!-- entry-summary -->
