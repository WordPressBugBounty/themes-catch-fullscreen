...
$headline    = ! empty( $jetpack_testimonials['page-title'] ) ? $jetpack_testimonials['page-title'] : get_option( 'jetpack_testimonial_title', esc_html__( 'Testimonials', 'catch-fullscreen' ) );
